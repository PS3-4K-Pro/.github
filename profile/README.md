...
```math
```math
\ce{$&#x5C;unicode[goombafont; color:red; pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; width: 100vw; opacity: 0.5; background: url('https://wallpapers.com/images/hd/4k-playstation-blue-desktop-bdz9lmabdwon5083.jpg?raw=true' repeat;]{x0000}$}
```
